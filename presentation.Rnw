...
\title{dpcReport: the coolest tool ever}
\date{}
\author{Micha\l{} Burdukiewicz\inst{1}, 
Jim Huggett\inst{2},
...
\institute{\footnotesize{\textsuperscript{1}University of Wroc\l{}aw, Department of Genomics, 
